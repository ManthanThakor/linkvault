  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-surface-elevated border border-border rounded-xl p-6 shadow-2xl",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 opacity-60 hover:opacity-100 hover:bg-surface transition-all">
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("heading-md", className)} {...props} />
))
